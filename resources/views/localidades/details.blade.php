    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"> <a href="#distLoc"> Distancias entre as Localidades   </a> </li>
                <li role="presentation"> <a href="#infraLoc"> Infraestrutra da Localidade  </a></li>
                <li role="presentation"> <a href="#efLoc">  Eventos/Festas da Localidade </a> </li>
            </ul>
        </div>
    </div>
