                            ...
                            <tbody> 
                                @foreach($eventoFesta as $ef)
                                    <tr> 
                                        ...
                                        <td> {{ !empty($ef->rede_social_add) ? $ef->rede_social_add : "Não informado" }} </td>
                                        <td> 
                                            <div style="display:flex;">
                                                <button class="btn btn-primary btn-xs btnEditLocalidadeEventoFesta"> 
                                                    <i class="fa fa-edit"> </i>
                                                </button>
                                                &nbsp;
                                                <button  class="btn btn-danger btn-xs btnDeleteLocalidadeEventoFesta"> 
                                                    <i class="fa fa-trash"> </i>
                                                </button>
                                            </div>
                                        </td>
